...
double Ecin;
    ...
    public:
        ...
        double get_pas ()const{return pas;}
    ...
    double get_comptechocparois()const {return comptechocsparois;}
    ...
    void set_temperature(double t){if(t>0) temperature = t;}
       ...
       double get_Ecin() const {return Ecin;}//pour l'extension 1

       double get_pression()const {return pression;}//pour l'extension 1

       void change_couleur();//pour l'extension 2

       void change_trace(){if (particules[1]->get_trace()){particules[1]->set_trace(false);}//pour l'exetnsion 3
                                     else{particules[1]->set_trace(true);}}

       void change_pas(bool b){if(b){pas=pas+0.0001;}//pour l'extension 1
           else{if (pas >=0.0001){pas=pas-0.0001;}}}
