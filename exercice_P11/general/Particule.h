...
class Particule : public Dessinable {
    ...
    int coordchocparoi;
    double vitessenormalechocparoi;//les 3 pour les extensions
    ...
    double get_infos(int n) const;//utilisée pour laffichage graphique notamment
    ...
    void updatevitessenormalechocparoi();
    ...
    void change_couleur(){if(couleur==false){couleur=true;}//pour l'extension 2
                         else{couleur=false;}}
};
